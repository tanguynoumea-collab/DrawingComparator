...
14. CI GitHub Actions (protocole de publication §5) : workflow build + tests + format sur PR et sur tag, rebuild indépendant du poste local, publish de l'artefact en Release. Le repo public existe (tanguynoumea-collab/DrawingComparator) mais la v0.1.0 a été construite localement.
