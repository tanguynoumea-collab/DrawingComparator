...
> Ratifiés au checkpoint de publication du cycle 1 (v0.1.0) ; rafraîchis au cycle 2 (PERT2-06).
...
5. **Reprenabilité et extensibilité** — les évolutions livrées au cycle 2 (rendu par région, affine 3 points, thème light, projets .dcproj) se sont-elles insérées sans refonte cachée, les prochaines actées en roadmap (3e point persisté, seuil de binarisation réglable, export tuilé étendu) s'insèrent-elles à leur tour, et un dev qui débarque trouve-t-il le chemin en moins d'une heure ?
